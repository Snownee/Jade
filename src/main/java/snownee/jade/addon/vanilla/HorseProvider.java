...
public class HorseProvider implements IEntityComponentProvider {
	...
	public void appendTooltip(ITooltip tooltip, EntityAccessor accessor, IPluginConfig config) {
		...
		tooltip.add(new TranslationTextComponent("jade.horseStat.jump", TextFormatting.WHITE + DisplayHelper.dfCommas.format(jumpHeight)));
		tooltip.add(new TranslationTextComponent("jade.horseStat.speed", TextFormatting.WHITE + DisplayHelper.dfCommas.format(iattributeinstance.getValue())));
	}
}
