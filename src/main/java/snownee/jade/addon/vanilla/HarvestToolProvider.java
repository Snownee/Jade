...
//import mcp.mobius.waila.api.impl.ElementHelper;
...
//        if (component != null) {
//            taggableList.setTag(BaseBlockProvider.OBJECT_NAME_TAG, ElementHelper.of(component, text));
//        }
//    }
//
//    @Override
...
//        if (name.isEmpty()) {
//            return ElementHelper.of(ElementHelper.item(tool, 0.75f, offsetY), ElementHelper.sub(sub));
//        } else {
//            return ElementHelper.of(ElementHelper.item(tool, 0.75f, offsetY), ElementHelper.sub(sub), ElementHelper.offsetText(name, 3, offsetY + 3));
//        }
//
