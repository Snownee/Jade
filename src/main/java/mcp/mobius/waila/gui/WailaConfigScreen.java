	...
	public OptionsListWidget getOptions() {
		...
		options.add(new OptionsEntryButton("general", new Button(0, 0, 100, 20, StringTextComponent.EMPTY, w -> {
			minecraft.displayGuiScreen(new OptionsScreen(WailaConfigScreen.this, "general") {
				...
				public OptionsListWidget getOptions() {
					...
					options.add(new OptionsEntryValueBoolean("display_entities", general.getDisplayEntities(), general::setDisplayEntities));
					options.add(new OptionsEntryValueBoolean("display_blocks", general.getDisplayBlocks(), general::setDisplayBlocks));
					...
					options.add(new OptionsEntryValueBoolean("display_item", general.shouldShowIcon(), general::setShowIcon));
		...
		options.add(new OptionsEntryButton("overlay", new Button(0, 0, 100, 20, StringTextComponent.EMPTY, w -> {
			minecraft.displayGuiScreen(new OptionsScreen(WailaConfigScreen.this, "overlay") {
				...
				public OptionsListWidget getOptions() {
					OptionsListWidget options = new OptionsListWidget(this, minecraft, width + 45, height, 32, height - 32, 30);
					options.add(new OptionsEntryValueSlider("overlay_alpha", overlay.getColor().getAlpha(), val -> overlay.getColor().setAlpha(val)));
					...
					options.add(new OptionsEntryValueSlider("overlay_scale", overlay.getOverlayScale(), overlay::setOverlayScale, 0.2f, 2));
		...
		options.add(new OptionsEntryButton("formatting", new Button(0, 0, 100, 20, StringTextComponent.EMPTY, w -> {
			minecraft.displayGuiScreen(new OptionsScreen(WailaConfigScreen.this, "formatting") {
				...
				public OptionsListWidget getOptions() {
					OptionsListWidget options = new OptionsListWidget(this, minecraft, width + 45, height, 32, height - 32, 30);
					options.add(new OptionsEntryValueInput<>("format_mod_name", formatting.getModName(), val -> formatting.setModName(val.isEmpty() || !val.contains("%s") ? formatting.getModName() : val)));
					options.add(new OptionsEntryValueInput<>("format_block_name", formatting.getBlockName(), val -> formatting.setBlockName(val.isEmpty() || !val.contains("%s") ? formatting.getBlockName() : val)));
					options.add(new OptionsEntryValueInput<>("format_fluid_name", formatting.getFluidName(), val -> formatting.setFluidName(val.isEmpty() || !val.contains("%s") ? formatting.getFluidName() : val)));
					options.add(new OptionsEntryValueInput<>("format_entity_name", formatting.getEntityName(), val -> formatting.setEntityName(val.isEmpty() || !val.contains("%s") ? formatting.getEntityName() : val)));
					options.add(new OptionsEntryValueInput<>("format_registry_name", formatting.getRegistryName(), val -> formatting.setRegistryName(val.isEmpty() || !val.contains("%s") ? formatting.getRegistryName() : val)));
					return options;
				}
			});
		})));
